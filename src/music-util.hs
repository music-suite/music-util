...
usage = do
    ...
    echo $ ""
    echo $ "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
    echo $ "Please note: `music-util` is a utility program for Music Suite"
    echo $ "development. If you just want to install the suite, simply type"
    echo $ ""
    echo $ "    cabal install music-suite"
    echo $ ""
    echo $ "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
    echo $ ""
    echo $ "Commands:"
